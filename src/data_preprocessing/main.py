...
def main(label_col_name: str, save: bool = True):
    ...
    if save:
        preprocessed_data_path = proj_root.joinpath(
            config["data_paths"]["preprocessed_data_path"]
        )
